    ...
    return (
      <Block style={styles.container}>
        <Block left flex={false} style={{ maxHeight: 155, marginBottom: 5 }}>
          <Text style={styles.title}>{I18n.t('profile.account_parameters.motivation_msgs')}</Text>
          <Text style={styles.subtitle}>{I18n.t('profile.account_parameters.motivation_msgs_subtitle')}</Text>
        </Block>
        <RadioGroup
          horizontal
          values={data}
